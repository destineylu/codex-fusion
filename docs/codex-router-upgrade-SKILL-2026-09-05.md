...
Xkiro Claude Opus 5 serialized-payload protection
  ...
  - publish effective autoCompact = 200,000 for this exact route; 230,000 was
    disproved on 2026-09-08 when a 222,739-token input produced 13,837 output
    tokens and the next serialized request jumped straight to 1,163,513 bytes
    before Codex had another chance to compact
...
200K context window. Do not lower `context_window` to 200K/300K merely to make
...
1. **Xkiro Claude Opus 5 payload-aware protection** — keep the 1M advertised
   context, compact conservatively at 200K, and block the exact route locally at
