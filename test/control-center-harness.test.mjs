...
test("Codex skill inventory validates frontmatter and parses Light preview paths", () => {
  assert.deepEqual(
    inspectSkillDocument(`---\nname: code\ndescription: Coding workflow\n---\n# Code\n`, "fallback"),
    { valid: true, name: "code", description: "Coding workflow" },
  );
  assert.equal(inspectSkillDocument("# test-runner\n", "test-runner").valid, false);
  assert.match(
    inspectSkillDocument(`---\nname: feishu-drive\ndescription: broken\nnot yaml content\n---\n`, "feishu-drive").error,
    /Invalid YAML frontmatter/,
  );
  assert.deepEqual(
    parseCodexSkillPreview("  [OFF]      xiaohongshu-box  C:/Users/test/.codex/skills/xiaohongshu-box/SKILL.md\n"),
    [{
      name: "xiaohongshu-box",
      path: "C:/Users/test/.codex/skills/xiaohongshu-box/SKILL.md",
      previewState: "OFF",
    }],
  );
});
