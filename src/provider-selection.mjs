...
// providers normally remain safe to include in the default, but an optional
// sidecar can set defaultEnabled=false until its separate lifecycle is ready.
export function defaultProviderIds() {
  ...
  return configuredProviderIds().filter((id) => {
