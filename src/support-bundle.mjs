...
import {
  ANTIGRAVITY_CLIENT_SECRET_PATH,
  CALLER_SECRET_PATH,
  CONFIG_PATH,
...
function knownLocalSecrets() {
  ...
  const files = [CALLER_SECRET_PATH, INTERNAL_SECRET_PATH, ANTIGRAVITY_CLIENT_SECRET_PATH];
  ...
  // The environment form remains supported for installer/headless setups even
  // though Control Center can now persist an owner-only copy in router state.
