...
const routerControl = Object.freeze({
  ...
  verifyProviderModel: (providerId, modelId) => call("verifyProviderModel", { providerId, modelId }),
  ...
  getCodexSkillControl: () => call("getCodexSkillControl"),
  getCodexAgentMode: () => call("getCodexAgentMode"),
  getCodexAutoResume: () => call("getCodexAutoResume"),
  getCodexChatGptWeb: () => call("getCodexChatGptWeb"),
  getCodexAccounts: () => call("getCodexAccounts"),
  ...
  setContextEconomy: (enabled) => call("setContextEconomy", { enabled }),
  ...
  startCodexAccountDeviceLogin: (label) => call("startCodexAccountDeviceLogin", { label }),
